...
for RELEASE in yakkety xenial wily vivid utopic trusty saucy raring quantal precise oneiric natty maverick lucid karmic jaunty intrepid hardy gutsy feisty edgy dapper breezy hoary warty ; do
  for ARCH in amd64 arm64 armel armhf ia64 i386 ppc64el powerpc sparc ; do
    for PACKAGE in libc libc6 libc6-i386 ; do
